      ...
      <CardContent>
        ...
        >
          ...
          {buttonStyle === ChatbotButtonStyle.BAR ? (
            <div className="flex justify-end flex-col items-end px-4 py-2.5">
              <ChatPreviewContent
...
const ChatPreviewContent = ({
  ...
  welcomeMessage,
  showBranding,
}: ChatPreviewContentProps): ReactElement => (
  <div
    className={`flex h-[480px] w-[360px] flex-col overflow-hidden bg-gray-50 shadow-2xl dark:bg-gray-900 z-5 ${panelRadius}`}
  >
    <div
